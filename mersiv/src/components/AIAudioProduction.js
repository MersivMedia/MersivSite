...
function AIAudioProduction() {
    const youtubeVideos = [
        { id: '1', embedId: 'QOujJItlh7s' },
        { id: '2', embedId: '0XguijaNNA0' },
        { id: '3', embedId: 'dQw4w9WgXcQ' },
        { id: '4', embedId: 'l60KcU2F7O4', isShort: true },
    ];

    const voiceServices = [
        'Multi-lingual translation',
        'Audio book voice generation',
        'Voice to voice changer',
    ...
    return (
        <>
            ...
            <main className="w-full px-6 pt-4 pb-20 relative">
                ...
                <section id="ai-audio-production" className="mb-20">
                    <div className="w-full md:w-4/5 lg:w-3/5 mx-auto bg-gray-700 bg-opacity-80 p-8 rounded-lg shadow-md">
                        <h2 className="text-3xl font-bold mb-8 text-center text-white">AI Assisted Audio Production</h2>
                        ...
                        <div className="mt-8 text-center">
                            ...
                            >
                                Check out more audio samples on our YouTube channel
                            </a>
                        </div>
                    </div>
                </section>

                <section id="ai-narration-voiceover" className="mb-20">
                    <div className="w-full md:w-4/5 lg:w-3/5 mx-auto bg-gray-700 bg-opacity-80 p-8 rounded-lg shadow-md">
                        <h2 className="text-3xl font-bold mb-8 text-center text-white">AI Narration and Voice Overs</h2>
...
export default AIAudioProduction;
